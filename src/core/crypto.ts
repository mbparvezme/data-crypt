...
export const encryptRaw = async (key: CryptoKey, iv: Uint8Array, data: Uint8Array): Promise<Uint8Array> => {
...
export const decryptRaw = async (key: CryptoKey, iv: Uint8Array, data: Uint8Array): Promise<Uint8Array> => {
